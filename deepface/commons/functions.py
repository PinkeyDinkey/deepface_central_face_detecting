...
def initialize_input(img1_path, img2_path=None):
    ...
    if type(img1_path) == list:
        ...
        if (type(img2_path) == str and img2_path != None) or (  # exact image path, base64 image
...
def detect_face(
    img, detector_backend="opencv", grayscale=False, enforce_detection=True, align=True, centre=True
):
    ...
    try:
        detected_face, img_region = FaceDetector.detect_face(
            face_detector, detector_backend, img, align, centre
        )
